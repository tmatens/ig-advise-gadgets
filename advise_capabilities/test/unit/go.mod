// Gadget-level unit test module. Out-of-tree consumers of IG's testing
// packages must mirror the replace directives from inspektor-gadget's own
// go.mod (replaces do not propagate across module boundaries).
module github.com/tmatens/ig-advise-gadgets/advise_capabilities/test/unit

go 1.25.7

require (
	github.com/inspektor-gadget/inspektor-gadget v0.54.0
